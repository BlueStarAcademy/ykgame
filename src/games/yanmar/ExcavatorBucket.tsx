  ...
  return (
    <group position={[0.98, -0.41, z]} rotation={[0, 0, -0.16]}>
      ...
      <mesh position={[0.075, -0.025, 0]}>
        ...
        <meshStandardMaterial color="#d3dbe3" roughness={0.2} metalness={0.75} />
      </mesh>
    </group>
  );
}
    ...
    <group>
      ...
      <group position={[-0.06, -0.07, 0]} scale={[-1, 1, 1]}>
        ...
        <mesh position={[0.52, -0.42, 0]} rotation={[0, 0, -0.18]}>
          ...
          <meshStandardMaterial color="#3b4651" roughness={0.5} metalness={0.38} />
        </mesh>
        ...
        <mesh position={[0.42, -0.24, 0]} rotation={[0, 0, -0.2]}>
          ...
          <meshStandardMaterial color="#1f2730" roughness={0.72} metalness={0.12} />
        </mesh>
