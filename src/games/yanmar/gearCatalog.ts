...
export const MASTER_OPTION_POOL: readonly MasterOptionDef[] = [
  ...
  { key: "floodBurnScore", label: "잔해 소각 시작 시 점수 추가", hideValue: false, min: 1000, max: 3000, isPercent: false, isDropRateBonus: false },
  { key: "floodBurnGearDrop", label: "잔해 소각 시작 시 장비 획득 확률 증가", hideValue: true, min: 10, max: 10, isPercent: true, isDropRateBonus: true },
