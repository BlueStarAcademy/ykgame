...
export function GrappleGripGauge({
  ...
  return (
    <div className="w-full min-w-0 rounded-xl border border-sky-200/40 bg-slate-900/80 px-2 py-1.5 shadow-lg backdrop-blur-sm">
      <div className="flex items-center gap-1.5">
        <span className="w-10 shrink-0 text-[8px] font-semibold text-emerald-200">
          적재 확률
        </span>
        ...
        <span className="w-7 shrink-0 text-right text-[8px] font-bold tabular-nums text-white">
          {adhesionPct}%
        </span>
      </div>
      <div className="mt-1 flex items-center gap-1.5">
        <span className="w-10 shrink-0 text-[8px] font-semibold text-sky-200">
          밀착감
        </span>
        <div className="h-1.5 min-w-0 flex-1 overflow-hidden rounded-full bg-white/15">
          <div
      ...
      <div className="mt-1 flex items-center gap-1.5">
        <span className="w-10 shrink-0 text-[8px] font-semibold text-slate-300">
          압력
        </span>
        ...
        <span className="w-7 shrink-0 text-right text-[8px] tabular-nums text-white/70">
          {pressurePct}%
        </span>
      </div>
    </div>
