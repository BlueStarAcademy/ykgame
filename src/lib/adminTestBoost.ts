...
/** Admin test target for monument/workshop points */
export const ADMIN_TEST_POINTS = 999_999;

/** Unlock all features through monument max-level gate (40) */
...
/**
 * Fill ADMIN accounts with test XP and monument/workshop points, and open the monument.
 * No-op when values are already at or above the targets.
 */
